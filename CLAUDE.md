...
rflectr claude --dry-run   # simulate full first-run without writing anything
rflectr claude --setup    # re-ask subscription tier
rflectr claude --trace    # write debug log to /tmp/rflectr-debug.log and print errors on exit
...
rflectr gemini           # Gemini CLI with registry providers
