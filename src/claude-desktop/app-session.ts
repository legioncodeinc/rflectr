...
export function getSessionLockPath(): string {
  return join(getClaudeDesktopHome(), '.rflectr.lock');
}
...
export function removeRflectrConfig(uuid: string): void {
