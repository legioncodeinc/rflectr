...
export const PROVIDER_TEMPLATES: ProviderTemplate[] = [
  ...
  },
  {
    ...
    supported: false,
    unsupportedReason: 'Requires AWS credentials — use rflectr providers import from OpenCode for now.',
  },
  {
    id: 'azure',
    name: 'Azure OpenAI',
    ...
    modelSource: 'manual-only',
    supported: false,
    unsupportedReason: 'Requires Azure deployment URLs — use rflectr providers import from OpenCode for now.',
  },
  {
    id: 'vertex',
  ...
  // OAuth-gated subscription providers — use rflectr providers auth <id> to sign in
  {
    id: 'github-copilot',
    name: 'GitHub Copilot',
    authType: 'oauth',
